...
import '../signup_organiser/organiser_address.dart';
import 'address_influencer.dart';


class AddInfluencerImage extends StatefulWidget {
  final String id;
  final Map<String, dynamic> data;

  const AddInfluencerImage(
      {super.key, required this.id, required this.data,
      });

  @override
  State<AddInfluencerImage> createState() => _AddInfluencerImageState();
}

class _AddInfluencerImageState extends State<AddInfluencerImage> {
                    ...
                    ElevatedButton(
                      onPressed: ()async {
                        try {
                          ...
                          Get.to(AddressInfluencer(id:widget.id.toString(), data: widget.data,));
                          setState(() {
                            uploadCover = null;
                          });
