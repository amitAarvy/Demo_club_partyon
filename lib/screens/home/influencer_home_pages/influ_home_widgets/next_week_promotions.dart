...
import 'package:club/screens/home/influencer_home_pages/influ_home_widgets/arrow_pages/next_week_promotions_arrow.dart';
...
class NextWeekPromotions extends StatefulWidget {
  const NextWeekPromotions({super.key});

  @override
  State<NextWeekPromotions> createState() => _NextWeekPromotionsState();
}

class _NextWeekPromotionsState extends State<NextWeekPromotions> {
  ...
  void fetchPendingRequests() async{
    ...
    pendingRequests = pendingRequests!.sublist(0, pendingRequests!.length <= 4 ? pendingRequests!.length : 4);
    setState(() {});
  }
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text("Next week promotion", style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)),
              InkWell(
                onTap: () {
                  Get.to(NextWeekPromotionsArrow());
                },
                child: Container(
