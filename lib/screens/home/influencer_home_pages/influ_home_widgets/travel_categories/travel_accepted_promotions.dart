...
class TravelAcceptedPromotions extends StatefulWidget {
  const TravelAcceptedPromotions({super.key});

  @override
  State<TravelAcceptedPromotions> createState() => _TravelAcceptedPromotionsState();
}

class _TravelAcceptedPromotionsState extends State<TravelAcceptedPromotions> {
