...
class TravelBarterPromotion extends StatefulWidget {
  const TravelBarterPromotion({super.key});

  @override
  State<TravelBarterPromotion> createState() => _TravelBarterPromotionState();
}

class _TravelBarterPromotionState extends State<TravelBarterPromotion> {
  ...
  void fetchPendingRequests() async{
    ...
    for(var element in data.docs){
      ...
      if(club.data() != null && (club.data() as Map<String, dynamic>)['businessCategory'] != null && club['businessCategory'] == 2) {
