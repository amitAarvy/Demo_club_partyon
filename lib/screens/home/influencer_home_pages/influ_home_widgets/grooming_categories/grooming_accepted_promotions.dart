...
class GroomingAcceptedPromotions extends StatefulWidget {
  const GroomingAcceptedPromotions({super.key});

  @override
  State<GroomingAcceptedPromotions> createState() => _GroomingAcceptedPromotionsState();
}

class _GroomingAcceptedPromotionsState extends State<GroomingAcceptedPromotions> {
  ...
  void fetchPendingRequests() async{
    ...
    for(var element in saveData){
      ...
      // .where('status', isEqualTo: widget.status)
          .get();
      if(reqData.docs.isNotEmpty && reqData.docs[0]['status'] == 4){
