...
class GroomingBarterPromotion extends StatefulWidget {
  const GroomingBarterPromotion({super.key});

  @override
  State<GroomingBarterPromotion> createState() => _GroomingBarterPromotionState();
}

class _GroomingBarterPromotionState extends State<GroomingBarterPromotion> {
  ...
  void fetchPendingRequests() async{
    ...
    for(var element in data.docs){
      ...
      if(club.data() != null && (club.data() as Map<String, dynamic>)['businessCategory'] != null && club['businessCategory'] == 3) {
    ...
    for(var element in saveData2){
      ...
      // .where('status', isEqualTo: widget.status)
          .get();
      if(reqData.docs.isNotEmpty && ((reqData.docs[0].data() as Map<String, dynamic>)['isPaid'] == null || (reqData.docs[0].data() as Map<String, dynamic>)['isPaid'] == false)){
