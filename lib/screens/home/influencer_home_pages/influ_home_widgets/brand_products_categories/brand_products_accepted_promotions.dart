...
class BrandProductsAcceptedPromotions extends StatefulWidget {
  const BrandProductsAcceptedPromotions({super.key});

  @override
  State<BrandProductsAcceptedPromotions> createState() => _BrandProductsAcceptedPromotionsState();
}

class _BrandProductsAcceptedPromotionsState extends State<BrandProductsAcceptedPromotions> {
