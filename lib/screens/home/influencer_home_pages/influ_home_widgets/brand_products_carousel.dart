...
import 'package:club/screens/home/influencer_home_pages/influ_home_widgets/arrow_pages/brand_slider_arrow.dart';
...
class BrandProductsCarousel extends StatefulWidget {
  final List groomingList;
  const BrandProductsCarousel({super.key, required this.groomingList});

  @override
  State<BrandProductsCarousel> createState() => _BrandProductsCarouselState();
}

class _BrandProductsCarouselState extends State<BrandProductsCarousel> {
  // List? groomingList;
  ...
  //   List groomData = data.docs.where((element) => (element.data() as Map<String, dynamic>)['businessCategory']!=null && element['businessCategory'] == 4).toList();
  //   groomingList = [];
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  const Text("Brands and products", style: TextStyle(color: Colors.white, fontSize: 25, fontWeight: FontWeight.bold)),
                  InkWell(
                    onTap: () {
                      Get.to(BrandSliderArrow());
                    },
                    child: Container(
