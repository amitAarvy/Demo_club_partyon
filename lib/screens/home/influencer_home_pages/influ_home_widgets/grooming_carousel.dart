...
import 'package:club/screens/home/influencer_home_pages/influ_home_widgets/arrow_pages/grooming_slider_arrow.dart';
...
class GroomingCarousel extends StatefulWidget {
  final List<Map<String, dynamic>> groomingList;
  const GroomingCarousel({super.key, required this.groomingList});

  @override
  State<GroomingCarousel> createState() => _GroomingCarouselState();
}

class _GroomingCarouselState extends State<GroomingCarousel> {
  ...
  //   QuerySnapshot clubsData = await FirebaseFirestore.instance.collection('Club').get();
  //   List groomData = clubsData.docs.where((element) => (element.data() as Map<String, dynamic>)['businessCategory']!=null && element['businessCategory'] == 3).toList();
  //   groomingList = [];
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  const Text("Grooming Industry", style: TextStyle(color: Colors.white, fontSize: 25, fontWeight: FontWeight.bold)),
                  InkWell(
                    onTap: () {
                      Get.to(GroomingSliderArrow());
                    },
                    child: Container(
            ...
            viewportFraction: kIsWeb ? MediaQuery.of(context).size.width > 650 ? 0.3 : 0.6 : 0.8,
            autoPlay: true,
                  ),
                ),
          ],
