...
class MyPromotion extends StatefulWidget {
  ...
  const MyPromotion({super.key, required this.eventId, required this.eventData, this.venuePr, this.prId});

  @override
  State<MyPromotion> createState() => _MyPromotionState();
}
  ...
  fetchPromotionDetails()async{
    ...
    try {
      ...
      for (var pr in detail.value) {
        ...
        totalAmount = totalAmountEntry + totalAmountTable;
      }
      setState(() {});
                              ...
                              Padding(
                                ...
                                child: GestureDetector(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Text('Fillars Entered',style: TextStyle(fontWeight: FontWeight.w600,color: Colors.orangeAccent,fontSize: 18),),
                                      Text('0',style: TextStyle(fontWeight: FontWeight.w600,color: Colors.orangeAccent,fontSize: 18),),
                                    ],
                                  ),
                                ),
                              )
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Text('0',style: TextStyle(fontWeight: FontWeight.w600,color: Colors.white,fontSize: 18),),
                                  ],
                                ),
                              ),
                            SizedBox(height: 10,),
                                ...
                                child: GestureDetector(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Text('${(prDetail[0]['userList'] as List).where((element) => element['duration'].toString() != '',).where((ele)=>ele['type'].toString()=='entry').length}',style: TextStyle(fontWeight: FontWeight.w600,color: Colors.orangeAccent,fontSize: 18),),
                                    ],
                                  ),
                                ),
                              ),
                                ...
                                child: GestureDetector(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Text('${(prDetail[0]['userList'] as List).where((element) => element['type'].toString() == 'table').where((ele) => ele['duration'].toString() != '',).length}',style: TextStyle(fontWeight: FontWeight.w600,color: Colors.orangeAccent,fontSize: 18),),
                                    ],
                                  ),
                                ),
                              ),
