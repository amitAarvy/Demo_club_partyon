...
import 'package:club/screens/venueAnalysis/promoterList.dart';
...
class VenueAnalysis extends StatelessWidget {
  final String collabType;
  final bool isPromotionalAnalysis;
  final String? isOrganiser;

  const VenueAnalysis({super.key, required this.collabType, this.isPromotionalAnalysis = false,  this.isOrganiser});
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      future: collabType == 'total'?FirebaseFirestore.instance
      ...
      builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
        ...
        if (snapshot.data != null) {
          ...
          data.sort((QueryDocumentSnapshot a, QueryDocumentSnapshot b) =>
              (b['startTime'] as Timestamp).toDate().compareTo((a['startTime'] as Timestamp).toDate()));
              ...
              child: Column(children: [
                ...
                ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    print('event id check is ${productData.data() as Map<String,dynamic>}');
                    ...
                    return GestureDetector(
                      onTap: () {
                        ...
                        //   ),
                        // );
                        Get.to(PromoterList(eventPromotionId: productData.id, eventId: productData['eventId'].toString(),data: productData,));
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: SizedBox(
                                            child: Center(
                                                child: Text(
                                                  '${DateFormat('dd-MM-yyyy \nhh:mm a').format(getKeyValueFirestore(productData, 'startTime').toDate() ?? DateTime.now())} onwards',
                                                  style: GoogleFonts.ubuntu(
                                                      color: Colors.white),
                                                ))),
                                      ),
