...
class TotalNoofclick extends StatefulWidget {
  final data;

  const TotalNoofclick({super.key, this.data});

  @override
  State<TotalNoofclick> createState() => _TotalNoofclickState();
}

class _TotalNoofclickState extends State<TotalNoofclick> {
