...
import '../../insta-analytics/presentation/views/instagram_data_screen_one/widgets/age_wise_engagement/age_bar_chart.dart';
import '../widget/age_bar_chart.dart';
import '../widget/bar_chart.dart';
import '../widget/reserved_pia_chart.dart';

class MyPromotionDetail extends StatefulWidget {
  final String eventId;
  final eventData;
  final String? venuePr;
  final String? prId;

  const MyPromotionDetail({super.key, required this.eventId, required this.eventData, this.venuePr, this.prId});

  @override
  State<MyPromotionDetail> createState() => _MyPromotionDetailState();
}

class _MyPromotionDetailState extends State<MyPromotionDetail> {
  ...
  fetchPromotionDetails()async{
    ...
    try {
      var data = await FirebaseFirestore.instance
          ...
          .where(
          'prId', isEqualTo: widget.venuePr == 'true' ? widget.prId : uid())
          .get();
      ...
      detail.value = data.docs
          .where((e) =>
      (e.data() as Map<String, dynamic>)['eventId'].toString() ==
      ...
      double totalAmountEntryFiller = 0.0;
      final docData = detail.value[0].data() as Map<String, dynamic>;
      if (docData.containsKey('userList')) {
        for (var data in detail.value[0]['userList'] as List) {
        ...
        fillerAmount =totalAmountEntryFiller;
        totalAmount = totalAmountEntry + totalAmountTable +totalAmountEntryFiller;
      }
      setState(() {});
      print('check promotion detail is $totalAmountEntry');
      print('check promotion detail is $totalAmountTable');
      print('check promotion detail is ${detail.value}');
  ...
  void initState() {
    ...
    fetchEventDetail();
    // print('check event lsit is ${widget.eventData['data']}');
    // log(widget.eventData['noOfReserved']);
  }


  ValueNotifier eventDetail = ValueNotifier(null);
  ValueNotifier<bool> eventLoading = ValueNotifier(false);
                            ...
                            children: [
                              Text('${DateFormat('dd-MM-yyyy').format(
                                  (widget.venuePr == 'true'
                                      ...
                                      : widget
                                      .eventData['data']['startTime'] as Timestamp)
                            ...
                            builder: (context, bool isLoading, child) {
                              ...
                              return ValueListenableBuilder(
                                ...
                                builder: (context, List prDetail, child) {
                                  ...
                                  final docData = prDetail[0].data() as Map<String,
                                      dynamic>;
                                  return   Column(
                                    children: [
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              SizedBox(
                                                ...
                                                child: PieChart(
                                                  dataMap: {
                                                    "Male": (prDetail[0]['userList'] as List)
                                                        .where((e) =>
                                                    e['gender'].toString() ==
                                                        'Male')
                                                        .length
                                                        .toDouble(),
                                                    "Female": (prDetail[0]['userList'] as List)
                                                        .where((e) =>
                                                    e['gender'].toString() !=
                                                        'Male')
                                                        .length
                                        ...
                                        Center(
                                          child: Row(
                                            ...
                                            children: [
                                              PieChart(
                                                dataMap: {
                                                  "Reserved": double.parse(
                                                      prDetail[0]['noOfReserved']
                                                          .toString()),
                                                  "NoShow": (prDetail[0]['userList'] as List)
                                                      .where((e) =>
                                                  e['noShow'].toString() == 'true')
                                                      .length
                                                      .toDouble(),
                                                },
                                                animationDuration: Duration(
                                          ...
                                          child: GestureDetector(
                                            onTap: () {
                                              showModalBottomSheet(
                                                ...
                                                context: context,
                                                builder: (context) {
                                                  return bottomHeading(
                                                      prDetail, type: 'filler');
                                                },);
                                            },
                                            child: Row(
                                              mainAxisAlignment: MainAxisAlignment
                                                  .spaceBetween,
                                              children: [
                                                Text('Fillers Entered',
                                                  style: TextStyle(
                                                      fontWeight: FontWeight.w600,
                                                      color: Colors.orangeAccent,
                                                      fontSize: 18),),
                                                Text('${(prDetail[0]['userList'] as List)
                                                    .where((element) =>
                                                element['checkIn'].toString() !=
                                                    '',)
                                                    .where((element) =>
                                                element['couponDetail']['appliedCoupon'].toString() ==
                                                    'filler',)
                                                    .where((ele) =>
                                                ele['type'].toString() == 'entry').toList()
                                      ...
                                      if(docData.containsKey('userList'))
                                        Padding(
                                          padding: const EdgeInsets.only(right: 10),
                                          child: widget.venuePr =='true'?Offstage():Row(
                                            mainAxisAlignment: MainAxisAlignment
                                                .spaceBetween,
                                            children: [
                                              Text('${widget.venuePr == 'true'
                                                ...
                                                style: TextStyle(
                                                    ...
                                                    color: Colors.white,
                                                    fontSize: 18),),
                                              Text(fillerAmount.toString(), style: TextStyle(
                                                  fontWeight: FontWeight.w600,
                                                  color: Colors.white,
                                                  fontSize: 18),),
                                            ],
                                        ...
                                        Padding(
                                          ...
                                          child:widget.venuePr =='true'?Offstage(): Row(
                                            ...
                                            children: [
                                              Text('${widget.venuePr == 'true'
                                                  ? 'Payout Commission'
                                                  : 'Commission Generated'}(${widget
                                                  .venuePr == 'true'
                                                  ? widget
                                                  .eventData['offeredCommissionPr']
                                                  : widget
                                                  .eventData['data']['pomotionData']['offeredCommissionPr'] }%)',
                                                style: TextStyle(
                                                    fontWeight: FontWeight.w600,
                                        ...
                                        Padding(
                                          ...
                                          child:widget.venuePr =='true'?Offstage(): Row(
                                            mainAxisAlignment: MainAxisAlignment
                                                .spaceBetween,
                                            children: [
                                              Text('${widget.venuePr.toString() ==
                                                  'true'
                                                  ? 'Payout Commission'
                                                  : 'Commission Generated'}(${widget
                                                  .venuePr == 'true'
                                                  ? widget
                                                  .eventData['offeredCommissionTablePr']
                                                  : widget
                                                  .eventData['data']['pomotionData']['offeredCommissionTablePr'] }%)',
                                                style: TextStyle(
                                                    fontWeight: FontWeight.w600,
                                      ...
                                      if(docData.containsKey('userList') && widget.venuePr !='true')
                                      ...
                                      if(docData.containsKey('userList'))
                                        Divider(color: Colors.grey.shade200,),
                                      SizedBox(height: 20,),
                                      // if(widget.venuePr != 'true' && docData.containsKey('userList'))
                                      //   Container(
                                      ...
                                      //       'Request Payout', style: TextStyle(
                                      //         color: Colors.white,
                                      //         fontWeight: FontWeight.w600),),),
                                      //   ),
                                      // SizedBox(height: 10,),
        ...
        child: Column(
          children: [
            ...
            Expanded(child: ClipRRect(
                ...
                child: ReservedPage(data: prDetail[0],type: type!,)))
          ],
        ),
      ),
    );
