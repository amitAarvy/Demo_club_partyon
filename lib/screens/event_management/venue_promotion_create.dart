...
class VenuePromotionCreate extends StatefulWidget {
  ...
  @override
  State<VenuePromotionCreate> createState() => _VenuePromotionCreateState();
}

class _VenuePromotionCreateState extends State<VenuePromotionCreate> {
  bool isNineSixteen = false;


  String menuID = const Uuid().v4();
  String invite = "inviteOnly";
...
//get text field values from server in edit Event
  ...
  void fetchEventPromotion()async{
    ...
    _eventName.text = promotionData['eventName'];
    noOfBarterCollabController.text = promotionData['noOfBarterCollab'].toString();
    ...
    selectedDate = promotionData['startTime'].toDate();
    ...
    durationInHours = (promotionData['endTime'].toDate() as DateTime).difference(promotionData['startTime'].toDate() as DateTime).inHours;
    setState(() {});
  }
            ...
            AspectRatio(
              ...
              child: Container(
                  ...
                  child: coverImages.isNotEmpty && uploadImages.isEmpty
                      ? eventCarousel(coverImages, aspectRatio: promotionType == PromotionType.story || promotionType == PromotionType.reel ? 9/16 : 4/5)
                      : uploadImages.isNotEmpty
                      ? eventCarousel(uploadImages, aspectRatio: promotionType == PromotionType.story || promotionType == PromotionType.reel ? 9/16 : 4/5)
                  //     : videos.isNotEmpty ?
  ...
  Widget videoUploadWidget(
      {File? uploadReel,
        required VoidCallback onTap,
        required String title,
        required VoidCallback onCancel}){
    double carouselHeight = 600.w;
    return Column(
      children: [
        Stack(
          children: [
            Container(
                ...
                child: uploadReel == null
                    ...
                    : Center(
                  child: Text(uploadReel.path.split('/').last, style: TextStyle(color: Colors.white)),
                ))
                .marginAll(20),
            Align(
                alignment: Alignment.topRight,
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child:  SingleChildScrollView(
        ...
        child: Container(
          margin: widget.isEditEvent ? EdgeInsets.only(top: 50.0) :EdgeInsets.only(top: 10.0),
          width:  Get.width,
          child: Form(
            key: _formKey,
            child: Column(
              children: [
                ...
                SizedBox(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        "Start Date: ${selectedDate.day} July ${selectedDate.year}",
                ...
                textField('Event Name', _eventName),
                textField("Budget", _title,isNum: true, isMandatory: true),
                ...
                textField("Specific Requirement", _briefEvent,
                    isInfo: true),
                textField('No. of barter collab\'s', noOfBarterCollabController, isNum: true, isMandatory: true),
                textField('Amount to be paid (if any)', amountPaidController, isNum: true),
                Padding(
                                  ...
                                  children: [
                                    ...
                                    if(offerFromMenu[index]['gender'].isNotEmpty)
                                      Column(
                                        children: [
                                          AppMultiDropdown(
                                            items: totalMenuData!.map((e) => DropdownItem(label: "${e['title']} (₹${e['price']})", value: "${e['title']}-${e['price']}")).toList(),
                    ...
                    ElevatedButton(
                          ...
                          try {
                            if (_title.text.isNotEmpty) {
                              ...
                              Map<String, dynamic> sendData = {
                                ...
                                "invite": invite,
                                'noOfBarterCollab': int.parse(noOfBarterCollabController.text),
                                ...
                                // 'pax': pax.text,
                                // 'inta': inta.text,
                                // 'menu': _artistName.text,
                                // 'name': homeController
                                //     .clubName.value.capitalizeFirst
                                //     .toString(),
                                // 'status': 1,
                                // 'isClub': true,
                                "acceptedBy": 0,
                      ...
                      style: ButtonStyle(
                          ...
                          backgroundColor: WidgetStateProperty.resolveWith(
                              (states) => Colors.black)),
                      child: Text(
                        widget.isEditEvent ? "Save & Post" : "Save & Post",
                        style: GoogleFonts.ubuntu(
                          color: Colors.orange,
                        ),
                      ),
