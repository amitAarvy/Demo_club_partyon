...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/usr/share/rvm/rubies/ruby-2.5.9")
  ...
  CONFIG["configure_args"] = " '--prefix=/usr/share/rvm/rubies/ruby-2.5.9' '--enable-load-relative' '--sysconfdir=/etc' '--disable-install-doc' '--enable-shared'"
  ...
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "gcc (Ubuntu 9.4.0-1ubuntu1~20.04.1) 9.4.0\nCopyright (C) 2019 Free Software Foundation, Inc.\nThis is free software; see the source for copying conditions.  There is NO\nwarranty; not even for MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE."
